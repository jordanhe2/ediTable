...
(function () {
    ...
    /*  getOS function taken from https://github.com/thorst/supportedBrowser.js/blob/master/src/browserInfo.js
        Licensed with MIT license Copyright (c) 2014 Todd Horst
    */
    var getOS = function () {
    ...
    var EdiTable = function (table, optOptions) {
        ...
        this.Selection = function () {
            ...
            var controlDown = (function (os) {
                var isMac = os.name.indexOf("Mac") > -1;
